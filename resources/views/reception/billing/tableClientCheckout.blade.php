...
<tr>
  	<td class="col-sm-1"> <input type="checkbox" value="true"></td>
  	<td class="col-sm-6"> {{$payment->item}} </td>
  	<td class="col-sm-1"> {{$payment->price}} </td>
  	<td class="col-sm-1"> {{$payment->qty}} </td>
  	<td class="col-sm-2"> {{$subtotal = $payment->price * $payment->qty}} </td>
</tr>
